<?php
       ...
       $query = "SELECT name,species FROM `Animal` WHERE exhibit='Jungle'";
       if (!empty($sort)) {
...
<html>
   <head>
      <title>Visitor Exhibit Details for Jungle</title>
...
function sort(type) {
    window.location = './ExhibitDetailJungle.php?sort=' + type;
}
</script>
   </body>
</html>